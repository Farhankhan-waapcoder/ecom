...
const CartDropdown = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Cart Dropdown */}
      <div className="absolute top-full right-0 mt-2 w-96 max-w-[90vw] bg-white rounded-xl shadow-2xl border border-gray-100 z-50 max-h-[80vh] overflow-hidden">
        {loading ? (
          ...
          <>
            {/* Header */}
            <div className="p-4 border-b border-gray-100 bg-gradient-to-r from-[#007580] to-[#005a63] text-white rounded-t-xl">
            ...
            {cartItems.length === 0 ? (
              ...
              <>
                  ...
                  {cartItems.map((item) => (
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        {/* Product Image */}
                        <div 
                          className="w-12 h-12 rounded-lg overflow-hidden bg-gray-100 flex-shrink-0 cursor-pointer"
                ...
                {/* Footer */}
                <div className="p-4 border-t border-gray-100 bg-gray-50 rounded-b-xl sticky bottom-0">
