  ...
  if (!order) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="w-full max-w-md text-center bg-white rounded-xl shadow-md p-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <button
                onClick={() => navigate(-1)}
                className="flex items-center space-x-2 text-sm px-3 py-1.5 rounded-md bg-gray-100 hover:bg-gray-200"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md">
              <div className="p-4 border-b">
                <h2 className="text-lg font-semibold flex items-center space-x-2 text-blue-600">
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600 space-x-4">
                      <span>
                        Price: <span className="font-semibold text-gray-900">{productPrice}</span>
                      </span>
                      <span>
                        Quantity: <span className="font-semibold text-gray-900">1</span>
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md">
              <div className="p-4 border-b">
                <h2 className="text-lg font-semibold flex items-center space-x-2 text-red-500">
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="flex items-center space-x-2 pt-2 border-t">
                  ...
                  <span className="text-sm text-gray-600">+91 {customerInfo.phone}</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Mail className="w-4 h-4 text-gray-400" />
                  <span className="text-sm text-gray-600">{customerInfo.email}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md">
              <div className="p-4 border-b">
                <h2 className="text-lg font-semibold flex items-center space-x-2 text-green-600">
            ...
            <div className="bg-white rounded-xl shadow-md">
              <div className="p-4 border-b">
                <h2 className="text-lg font-semibold flex items-center space-x-2 text-purple-600">
                ...
                <div className="flex justify-between">
                  ...
                  <span
                    className={`font-medium ${
                      customerInfo.whatsappUpdates ? "text-green-600" : "text-gray-500"
                    }`}
                  >
