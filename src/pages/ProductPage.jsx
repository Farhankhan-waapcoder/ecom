        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-xl p-4">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">Free delivery on orders above ₹500</p>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <button 
                ...
                className="h-14 px-8 border-2 border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 rounded-xl font-semibold hover:bg-slate-50 dark:hover:bg-slate-700 hover:border-slate-400 dark:hover:border-slate-500 transition-all duration-200"
              >
                Buy Now
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600 dark:text-slate-400">On orders over ₹500</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600 dark:text-slate-400">2 year coverage</p>
                </div>
              </div>
