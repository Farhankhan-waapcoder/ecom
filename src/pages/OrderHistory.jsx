      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="space-y-4">
          {orders.map((order) => {
            ...
            return (
              <div key={order.id} className="bg-white rounded-xl shadow-sm border hover:shadow-md transition-shadow overflow-hidden">
                <div className="p-4 sm:p-6">
                  ...
                  <Link
                    to={`/order/${order.id}`}
                    className="flex items-start space-x-3 sm:space-x-4 hover:bg-gray-50 rounded-lg p-3 sm:p-4 -m-3 sm:-m-4 transition-colors"
                  >
                    <img 
                      src={order.productImage} 
                      alt={order.productName} 
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base line-clamp-2">{order.productName}</h3>
                    ...
                    <div className="text-right flex-shrink-0">
                      <p className="text-base sm:text-lg font-semibold text-gray-900">₹{order.productPrice}</p>
                      <p className="text-xs sm:text-sm text-blue-600 hover:text-blue-700 mt-1">View Details →</p>
                    </div>
                  </Link>
                  ...
                  <div className="mt-4 pt-4 border-t">
                    ...
                    <div className="sm:hidden">
                      <div className="flex flex-col space-y-2">
                        <Link
                          to={`/order/${order.id}`}
                          className="w-full px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium text-center"
                        >
                          Track Order
                        </Link>
                        {status === "Delivered" && (
                          <Link
                            to={`/product/${order.id}`}
                            className="w-full px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium text-center"
                          >
                            Buy Again
                          </Link>
                        )}
